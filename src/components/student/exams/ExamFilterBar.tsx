...
export type ExamFilterStatus = 'ALL' | 'OPEN' | 'ENROLLED' | 'UPCOMING';

interface ExamFilterBarProps {
  searchQuery: string;
  setSearchQuery: (val: string) => void;
  selectedStatus: ExamFilterStatus;
  setSelectedStatus: (val: ExamFilterStatus) => void;
  totalResults: number;
}
...
export function ExamFilterBar({
  ...
  const tabs: { id: ExamFilterStatus; label: string }[] = [
    { id: 'ALL', label: 'All Exams' },
    { id: 'OPEN', label: 'Open for Registration' },
    { id: 'ENROLLED', label: 'My Enrolled Only' },
